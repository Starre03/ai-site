...
export default function TermsPage() {
  ...
  const sections = [
    ...
    },
    {
      ...
      text: "Deze algemene voorwaarden zijn van toepassing op alle aanbiedingen, offertes en overeenkomsten tussen StarLeo en opdrachtgever. Afwijkingen zijn alleen geldig indien schriftelijk overeengekomen. De toepasselijkheid van eventuele inkoop- of andere voorwaarden van opdrachtgever wordt uitdrukkelijk van de hand gewezen.",
    },
    {
      title: "3. Aanbiedingen en offertes",
      text: "Alle aanbiedingen en offertes van StarLeo zijn vrijblijvend, tenzij uitdrukkelijk anders vermeld. Een overeenkomst komt tot stand op het moment dat opdrachtgever een offerte schriftelijk of per e-mail accepteert, of wanneer StarLeo feitelijk met de uitvoering van de opdracht begint.",
    },
    {
      title: "4. Uitvoering van de overeenkomst",
      text: "StarLeo voert de diensten uit naar beste inzicht en vermogen, conform de eisen van goed vakmanschap. De overeenkomst betreft een inspanningsverplichting, geen resultaatsverplichting. StarLeo heeft het recht om werkzaamheden te laten uitvoeren door derden indien dit de kwaliteit of voortgang ten goede komt.",
    },
    {
    ...
    },
    {
      ...
      text: "De aansprakelijkheid van StarLeo is beperkt tot het bedrag dat in het desbetreffende geval onder de beroepsaansprakelijkheidsverzekering wordt uitbetaald, vermeerderd met het eigen risico. Indien geen uitkering plaatsvindt, is de aansprakelijkheid beperkt tot het factuurbedrag van de betreffende opdracht, met een maximum van het bedrag dat in de drie maanden voorafgaand aan de schadeveroorzakende gebeurtenis door opdrachtgever is betaald. StarLeo is niet aansprakelijk voor indirecte schade, waaronder gevolgschade, gederfde winst of gemiste besparingen.",
    },
    {
      title: "10. Overmacht",
      text: "In geval van overmacht is StarLeo niet gehouden tot het nakomen van enige verplichting. Onder overmacht wordt verstaan elke omstandigheid buiten de macht van StarLeo die nakoming van de overeenkomst geheel of gedeeltelijk verhindert, waaronder storingen in systemen van derden, internetverbindingen, stroomuitval en wijzigingen in API-voorwaarden van derde partijen.",
    },
    {
      title: "11. Opzegging en ontbinding",
      text: "Beide partijen kunnen de overeenkomst schriftelijk opzeggen met inachtneming van een opzegtermijn van 14 dagen. Bij tussentijdse opzegging is opdrachtgever gehouden tot betaling van de tot dat moment verrichte werkzaamheden. StarLeo is gerechtigd de overeenkomst met onmiddellijke ingang te ontbinden indien opdrachtgever niet aan betalingsverplichtingen voldoet of indien omstandigheden dit rechtvaardigen.",
    },
    {
      title: "12. Toepasselijk recht en geschillen",
      text: "Op alle overeenkomsten tussen StarLeo en opdrachtgever is Nederlands recht van toepassing. Geschillen worden voorgelegd aan de bevoegde rechter in het arrondissement waar StarLeo is gevestigd.",
    },
    {
      title: "13. Wijzigingen",
      text: "StarLeo behoudt zich het recht voor deze algemene voorwaarden te wijzigen. De meest recente versie is altijd beschikbaar op deze pagina. Bij wezenlijke wijzigingen wordt opdrachtgever hiervan op de hoogte gesteld.",
    },
  ];
  ...
  return (
    <PageSection bg={C.bg} pad="8.5rem clamp(1.5rem, 5vw, 5rem) 5rem">
      <SectionHeading
        ...
        text="Van toepassing op alle diensten van StarLeo."
      />
