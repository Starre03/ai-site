...
export const QUESTIONS = [
  {
    ...
    stepId: "v1-sector",
    kind: "single",
    title: "In welke sector opereert je bedrijf vooral?",
    options: [
  ...
  },
  {
    ...
    options: [
      { value: "klantcontact-support", label: "Klantcontact, support en opvolging" },
      { value: "administratie-invoer", label: "Administratie, invoer en controles" },
      { value: "data-rapportage", label: "Data verzamelen, controleren en rapporteren" },
      { value: "marketing-content-ads", label: "Content maken, aanpassen en publiceren" },
      { value: "documenten-dossiers", label: "Offertes, documenten en dossiers" },
      { value: "intake-planning-opvolging", label: "Intake, planning en leadopvolging" },
    ],
  },
  {
    id: "weeklyHours",
    stepId: "v4-uren",
    kind: "single",
    title: "Hoeveel van dat werk is per week terugkerend en grotendeels hetzelfde?",
  ...
  },
  {
    ...
    options: [
      { value: "crm", label: "CRM" },
      { value: "boekhouden", label: "Finance" },
  ...
  },
  {
    ...
    stepId: "v7-pijnpunt",
    kind: "single",
    title: "Waar loopt dit proces nu het meest vast?",
